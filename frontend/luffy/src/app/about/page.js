...
import img1 from '../../images/Luffy__1950.jpg';
  ...
  return (
    <div className="bg-white">
      ...
      <footer className="mt-32 bg-gray-900 sm:mt-56" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32 place-content-center">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8 place-content-center">
            <img
              className="h-7"
              src=""
              alt=""
